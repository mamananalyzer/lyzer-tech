                ...
                <div class="row">
                    <div id="scrollable-card" class="row perfect-scrollbar">
                        <div class="col-12 scrollable-card">
                            <div class="card overflow-hidden mb-6" style="height: 7vh;">
                                <div class="card-body" id="both-scrollbars-example">
                                    <button type="button" class="btn btn-text-primary" onclick="downloadCSV()">Download as
                                        CSV</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card overflow-hidden mb-6" style="height: 66vh;">
                                <div class="card-body ps ps--active-x ps--active-y pt-0" id="both-scrollbars-example">
                                    <div class="d-flex" id="scrollbars">
                                            ...
                                            <div class="card-border-shadow-primary h-100">
                                                <div class="card-body p-0">
                                                    <div class="sticky-header">
                                                        <h5 class="card-title mb-0 d-flex justify-content-center">Parameter
                                                        </h5>
                                                    </div>
                                                    @php
                                                        $heads = [
                                                        ...
                                                        <thead class="sticky-header">
                                                            <tr>
                                                                @foreach ($heads as $head)
                                                                    <th>
                                                                        <span
                                                                            class="d-block fw-medium mb-1">{{ $head['label'] }}</span>
                                                                    </th>
                                                                @endforeach
                                                            </tr>
                                                        </thead>
                                                                ...
                                                                <tr>
                                                                    @foreach ($attributes as $attribute)
                                                                        <td style="width: 1%; white-space: nowrap;">
                                                                            <span
                                                                                class="d-block fw-medium mb-1 d-flex justify-content-end p-0">{{ $attribute['value'] }}
                                                                                {{ $attribute['unit'] }}</span>
                                                                        </td>
                                                                    @endforeach
                                                                </tr>
                                        ...
                                        {{-- download dataLog -> CSV --}}
                                        <script>
                                            function downloadCSV() {
                                                const table = document.getElementById("dataLog");
                                                let csvContent = "";
                                                ...
                                                link.download = "table_data.csv"; // File name
