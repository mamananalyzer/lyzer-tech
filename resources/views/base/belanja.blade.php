...
@section('link')
    ...
    <link rel="stylesheet" href="sneat/assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css">
    ...
    <!-- Row Group CSS -->
    <link rel="stylesheet" href="sneat/assets/vendor/libs/datatables-rowgroup-bs5/rowgroup.bootstrap5.css">
            ...
            <div class="dt-buttons btn-group flex-wrap"> 
                ...
                <button class="btn btn-secondary create-new btn-primary" data-bs-toggle="modal" data-bs-target="#basicModal">
                    <span><i class="bx bx-plus me-sm-1"></i> 
                        <span class="d-none d-sm-inline-block">Tambah Belanja</span>
                    </span>
                </button> 
            </div>
        </div>
